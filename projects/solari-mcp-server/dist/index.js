...
let activeSolariBrowserClient = null;
...
async function getOrInitSandbox() {
    if (!activeSandbox) {
        const client = getSandboxClient();
        if (!client)
            throw new Error("Solari API client is not initialized.");
...
server.registerTool("solari_sandbox_exec", {
...
server.registerTool("solari_sandbox_file_write", {
...
server.registerTool("solari_sandbox_file_read", {
...
server.registerTool("solari_sandbox_preview_port", {
...
server.registerTool("solari_browser_stealth_test", {
...
server.registerTool("solari_desktop_launch", {
